...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
				...
				case "script":
					$.ajax($.extend({
						...
						success:function(data,st, xhr) {
							...
							if(ts.p.formatData && $.isFunction(ts.p.formatData)){
								data = ts.p.formatData(data);
							}
		...
		sortByColumn = function(data, index, idxcol){
			var rows = data ? data.rows : [];
			var key = index.replace('jqgh_jqgrid_', '');
			...
			rows.sort(function(a, b){
				...
				if(a.cell){
					compareA = a.cell[idxcol];
					compareB = b.cell[idxcol];
				}else{
					compareA = a[key];
					compareB = b[key];
				}
		...
		oldSortFunction = function (index, idxcol, reload, sor, obj){
			...
			//populate(); //txm: TODO no need to send request to get the data for sorting
			ts.p.lastsort = idxcol;
		...
		sortData = function (index, idxcol,reload,sor, obj){
			...
			if(ts.p.colModel[idxcol].sortable !== true){
				return;
			}

			oldSortFunction(index, idxcol, reload, sor, obj);
			data = sortByColumn(currentPageData, index, idxcol);
			//data = {"userdata":{},"records":4,"page":"1","rows":[{"id":1,"order_id":"D151122223322","order_time":"2015-12-21T00:11:23Z","payment_type":1,"is_lock":true,"user_remark":null,"vender_remark":null,"order_flags":"","need_invoice":true,"shop_name":"天猫旗舰店5566","order_status_name":"促销计算完成\n","company_name":null,"total":3.0,"paid_amount":22.0,"user_name":"东方卫视","user_mobile":"13322222222","quantity":null,"consignee_name":null,"consignee_phone":null,"order_quantity":33,"address":null,"is_rx":false,"rx_tag":"否","lock_tag":"是","need_invoice_tag":"需要","payment_type_tag":"在线支付"},{"id":2,"order_id":"D151122223321","order_time":"2015-12-21T00:11:23Z","payment_type":1,"is_lock":null,"user_remark":null,"vender_remark":null,"order_flags":"","need_invoice":true,"shop_name":"天猫旗舰店3344","order_status_name":"订单完成","company_name":"水水水水","total":null,"paid_amount":null,"user_name":"东方卫视","user_mobile":"13322222222","quantity":null,"consignee_name":null,"consignee_phone":null,"order_quantity":null,"address":null,"is_rx":true,"rx_tag":"是","lock_tag":"否","need_invoice_tag":"需要","payment_type_tag":"在线支付"},{"id":3,"order_id":"D151122223323","order_time":"2015-12-21T00:11:23Z","payment_type":1,"is_lock":true,"user_remark":null,"vender_remark":null,"order_flags":"","need_invoice":true,"shop_name":"天猫旗舰店","order_status_name":"订单完成(妥投)","company_name":"水水水水","total":null,"paid_amount":null,"user_name":"东方卫视","user_mobile":"13322222222","quantity":null,"consignee_name":null,"consignee_phone":null,"order_quantity":null,"address":null,"is_rx":false,"rx_tag":"否","lock_tag":"是","need_invoice_tag":"需要","payment_type_tag":"在线支付"},{"id":3,"order_id":"D151122223323","order_time":"2015-12-21T00:11:23Z","payment_type":1,"is_lock":true,"user_remark":null,"vender_remark":null,"order_flags":"","need_invoice":true,"shop_name":"天猫旗舰店","order_status_name":"订单完成(妥投)","company_name":"水水水水","total":null,"paid_amount":null,"user_name":"东方卫视","user_mobile":"13322222222","quantity":null,"consignee_name":null,"consignee_phone":null,"order_quantity":null,"address":null,"is_rx":false,"rx_tag":"否","lock_tag":"是","need_invoice_tag":"需要","payment_type_tag":"在线支付"}],"total":1};
